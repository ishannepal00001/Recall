      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <div className="rounded-2xl bg-white/[0.06] border border-white/10 p-5">
          ...
          <p className="text-2xl font-bold text-white mt-1 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-secondary" /> 12
          </p>
        ...
        <div className="rounded-2xl bg-white/[0.06] border border-white/10 p-5">
          ...
          <p className="text-2xl font-bold text-white mt-1 flex items-center gap-2">
            <span className="w-7 h-7 rounded-lg bg-teal flex items-center justify-center text-xs">⬢</span> 3
          </p>
          <div className="h-1.5 rounded-full bg-white/10 mt-3 overflow-hidden flex">
            <div className="h-full bg-teal" style={{ width: '45%' }} />
          </div>
        </div>
        <div className="rounded-2xl bg-primary p-5 text-white">
          <p className="text-sm text-white/80">Quick action</p>
          <button className="mt-3 bg-white text-primary px-4 py-2 rounded-xl text-sm font-medium">+ Create new</button>
        </div>
      </div>
